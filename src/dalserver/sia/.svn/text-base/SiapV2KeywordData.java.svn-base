 ...
 */
public class SiapV2KeywordData {
  ...
  "query_score,Double,Query.Score,,Degree of match to query parameters,,,double,,,,Q",
  ...
  "access_format,String,Access.Format,,Content or MIME type of dataset,,9;@ID,char,*,,,Qm",
  "access_estsize,Long,Access.Size,meta.number,Estimated dataset size,,10;@ID,long,,,kB,Qq",
  ",,,,,,,,,,,",
  ",Type,UTYPE,UCD,Description,FITS,CSV,DataType,ArraySize,Unit,SiapUnit,Hint",
  ",,,,,,,,,,,",
  ...
  "dataset_length,Long,Dataset.Length,meta.number,Number of pixels,,,long,,,,q",
  "dataset_deleted,String,Dataset.Deleted,,Set if dataset is deleted,,,char,*,,,",
  ",,,,,,,,,,,",
  ",Image,Image,,Image-specific Dataset metadata,,,,,,,",
  "im_nsubarrays,Long,Image.Nsubarrays,meta.number,Number of image subarrays,,,long,,,,q",
  "im_naxes,Long,Image.Naxes,meta.number,Number of image axes,,4;@ID,long,,,,m",
  "im_naxis,Long[][],Image.Naxis,meta.number,Length of each axis of each subarray,,5;@ID,long,*,,,m",
  "im_pixtype,String,Image.Pixtype,,Pixel datatype,,,char,*,,,q",
  "im_wcsaxes,String[],Image.WCSAxes,,WCS axis coordinate types,,7;@ID,char,*,,,q",
  "im_scale,Double,Image.Scale,,Image spatial scale in arcsec per pixel,,6;@ID,double,,arcsec,arcsec,q",
  ...
  "obs_collection,String,DataID.Collection,,Data collection to which dataset belongs,COLLECT,11;@ID,char,*,,,m",
  ...
  "obs_publisher_did,URI,Curation.PublisherDID,meta.ref.url;meta.curation,Publisher's ID for the dataset ID,DS_IDPUB,12;@ID,char,*,,,m",
  ...
  "s_ra,Double,Char.SpatialAxis.Coverage.Location.Coord.Position2D.Value2.C1,pos.eq.ra;meta.main,Spatial position first coordinate,,2;@ID,,,,,m",
  "s_dec,Double,Char.SpatialAxis.Coverage.Location.Coord.Position2D.Value2.C2,pos.eq.dec;meta.main,Spatial position second coordinate,,3;@ID,,,,,m",
  "s_fov,Double,Char.SpatialAxis.Coverage.Bounds.Extent.Diameter,pos.AngSize;instr.fov,Diameter of field of view,,,double,,deg,deg,m",
  ...
  "s_sys_error,Double,Char.SpatialAxis.Accuracy.SysError.RefVal.Value,stat.error.sys;pos.eq,Astrometric systematic error,SKY_SYE,,double,,deg,deg,p",
  ...
  "em_unit,String,Char.SpectralAxis.Unit,meta.unit,Unit for spectral coord,,,char,*,,m,",
  "em_bandpass,Double,Char.SpectralAxis.Coverage.Location.Coord.Spectral.Value,em.wl;instr.bandpass,Spectral coord value,SPEC_VAL,,double,,,m,",
  ...
  "em_min,Double,Char.SpectralAxis.Coverage.Bounds.Limits.LoLimit,em.wl;stat.min,Start in spectral coordinate,TDMIN,,double,,,m,m",
  "em_max,Double,Char.SpectralAxis.Coverage.Bounds.Limits.HiLimit,em.wl;stat.max,Stop in spectral coordinate,TDMAX,,double,,,m,m",
  ...
  "em_res_power,Double,Char.SpectralAxis.Resolution.ResolPower.RefVal,spect.resolution,Spectral resolving power,SPEC_RP,,double,,,,q",
  ...
  "t_midpoint,Double,Char.TimeAxis.Coverage.Location.Coord.Time.TimeInstant,time.epoch;obs,Midpoint of exposure on MJD scale,DATE-OBS,,double,,d,d,",
  "t_extent,Double,Char.TimeAxis.Coverage.Bounds.Extent,time.duration;obs.exposure,Total exposure time,TELAPSE,,double,,,s,",
  "t_min,Double,Char.TimeAxis.Coverage.Bounds.Limits.StartTime,time.start;obs.exposure,Start time,TSTART,,double,,,d,m",
  "t_max,Double,Char.TimeAxis.Coverage.Bounds.Limits.StopTime,time.stop;obs.exposure,Stop time,TSTOP,,double,,,d,m",
  "t_exptime,Double,Char.TimeAxis.Coverage.Support.Extent,time.duration;obs.exposure,Effective exposure time,EXPOSURE,8;@ID,double,,,s,m",
  ...
  "o_ucd,String,Char.ObservableAxis.UCD,meta.ucd,UCD for observable,,,char,*,,,m",
  "o_unit,String,Char.ObservableAxis.Unit,meta.unit,Unit for observable,,,char,*,,,m",
  ...
  "pol_states,String,Char.PolAxis.StateList,meta.code;phys.polarization;meta.fits   ,List of polarization states present,,,char,*,,,m",
  ",,,,,,,,,,,",
  ",,,,,,,,,,,",
  "#           Field ID,Type,UTYPE,UCD,Description,FITS,CSV,DataType,ArraySize,Unit,SiapUnit,Hint",
  "## DATA Model,,,,,,,,,,,",
