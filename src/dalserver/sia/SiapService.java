...
public class SiapService {
	...
	if (params == null) {
	    ...
	    this.schemaName = params.getValue("schemaName");
	...
	if (queryType.equalsIgnoreCase("test")) {
		...
		try {
		    // Create fields in the output table for all columns in the
		    // main SIAV2 DBMS metadata table defined for this service.
