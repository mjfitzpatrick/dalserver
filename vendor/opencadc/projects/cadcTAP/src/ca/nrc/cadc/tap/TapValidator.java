...
public class TapValidator
{
    ...
    public void validate(List<Parameter> paramList)
    {
        if (paramList == null || paramList.isEmpty())
            throw new IllegalStateException("Empty param list: Missing required parameter: REQUEST");

        //  REQUEST
        String request = ParameterUtil.findParameterValue("REQUEST", paramList);
        if (request == null || request.trim().length() == 0)
            throw new IllegalStateException("Missing required TAP parameter: REQUEST");
