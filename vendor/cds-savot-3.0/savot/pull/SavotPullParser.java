...
public class SavotPullParser {
    ...
    private SavotStatistics stats = new SavotStatistics();
     ...
     *            a file to parse
     * @param mode
     *            FULL or SEQUENTIAL (for small memory size applications)
     */
	...
	try {
	    ...
	    engine = new SavotPullEngine(parser, file, mode, debug, stats);
	...
	try {
	    ...
	    engine = new SavotPullEngine(parser, url, mode, enc, debug, stats);
